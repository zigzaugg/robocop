...
#	wiggle = True
	...
	while not rospy.is_shutdown():
		...
		# behavior 2: if fallen STAND
		else:
			#is_zero = False
			stand()
			
			'''# behavior 2: toggle flailing
			if wiggle:
				response = setMotorTargetPositionCommand(3, 412)
				response = setMotorTargetPositionCommand(4, 612)
				response = setMotorTargetPositionCommand(7, 812)
				response = setMotorTargetPositionCommand(8, 212)
			else:
				response = setMotorTargetPositionCommand(3, 512)
				response = setMotorTargetPositionCommand(4, 512)
				response = setMotorTargetPositionCommand(7, 712)
				response = setMotorTargetPositionCommand(8, 312)
			wiggle = not wiggle'''
